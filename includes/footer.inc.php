...
<footer class="footer">
  <div class="footer-left">
    <a href="./index.php"><img src="./assets/images/world-news-logo-light.png" /></a>
    <p>
      The collection point of World News. A one stop shop. We bring to you the current happenings around the world from
      esteemed writers. Make sure to read up and keep up with us through this platform that we bring to you. World News
    </p>
    <div class="socials">
  ...
  <div class="footer-bottom">
    <p>All Rights Reserved by &copy; WorldNews <?php echo date("Y") ?></p>
  </div>
</footer>
